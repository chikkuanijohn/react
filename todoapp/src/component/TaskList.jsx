...
const AddTask = () => {
    ...
    const [currentTask,setDescription] = useState({id:null, tittle:''});

    useEffect( () =>{
        axios.get('https://aswanth74.pythonantwhere.com/api/tasks/')
    ...
    const updateTask =(id,updatedTask) => {
         setEditing(false);
         axios.put('htto://localhost:8000/api/tasks/${id}',updatedTask)
             .then(response => {
